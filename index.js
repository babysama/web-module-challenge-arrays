...
function removeFlavorByName(arr, flavor){
  let flavorIndex = arr.indexOf(flavor);
  // console.log(flavorIndex)
  let frontArr = arr.slice(0, flavorIndex);
  // console.log(frontArr);
  let backArr = arr.slice(flavorIndex + 1, arr.length);
  // console.log(backArr);
  frontArr.push(...backArr);
  return frontArr;
}
